...
from compiler.gen import func_impl_list
...
class Parser:
    ...
    def function_def(self):
        ...
        return ('unify',
                ('id',id_tok.value),
                ('function-exp', ('implementation',name)))
    ...
    def primary(self):
        ...
        if tt == 'INTEGER':
           ...
           return ('none', None)
            ...
            name = unique_name()
            func_impl_list.append((name,('escape', str_tok.value)))

            return ('escape', ('implementation', name))
